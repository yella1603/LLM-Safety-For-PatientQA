...
questions_df = pd.read_csv('/local/scratch/ydiekma/PatientFacingLLM-Eval/questions_rephrased_temp_0.6_missingrows.csv')
...
for temperature in [0.6, 0.5, 0.4, 0.3, 0.2, 0.1]:
    output_file = f'/local/scratch/ydiekma/PatientFacingLLM-Eval/missing_rows/meditron7B0_temp_{temperature}.csv'
